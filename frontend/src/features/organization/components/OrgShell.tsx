...
function navItems(orgId: string, langQuery: string) {
  return [
    ...
    },
    {
      ...
      href: `${routes.organization.subscription(orgId)}${langQuery}`,
      labelKey: "navSubscription",
    },
    {
      key: "planChange" as const,
      href: `${routes.organization.planChange(orgId)}${langQuery}`,
      labelKey: "navPlanChange",
    },
    {
      key: "billing" as const,
      href: `${routes.organization.billing(orgId)}${langQuery}`,
      labelKey: "navBilling",
    },
    {
      key: "usage" as const,
    ...
    },
    {
      ...
      href: `${routes.organization.cancel(orgId)}${langQuery}`,
      labelKey: "navCancellation",
    },
    {
