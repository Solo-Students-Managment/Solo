...
export const routes = {
  ...
  search: {
    ...
    aiGrading: () => "/personal/ai/grading",
    aiPrivacy: () => "/personal/ai/privacy",
    offlineSync: () => "/personal/offline-sync",
    collabEditing: () => "/personal/collab",
    presenceCalendar: () => "/personal/presence",
    gamification: () => "/personal/gamification",
    advancedAutomation: () => "/personal/advanced-automation",
    integrationCenter: () => "/personal/integrations",
    a11yAccommodations: () => "/personal/accessibility",
    pwaHardening: () => "/personal/pwa-status",
    securityHardening: () => "/personal/security-review",
    releaseReadiness: () => "/personal/release-readiness",
    legacyClosure: () => "/personal/legacy-closure",
  },
  admin: {
    home: () => "/admin",
    users: () => "/admin/users",
