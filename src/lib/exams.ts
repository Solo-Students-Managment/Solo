...
export function normalizeExam(exam: Exam): Exam {
  return {
    ...exam,
    questions: exam.questions.map((question) => normalizeQuestion(question as ExamQuestion | LegacyQuestion)),
  }
}
...
function isExamAnswers(
  answers: ExamAnswers | Record<string, number>,
): answers is ExamAnswers {
